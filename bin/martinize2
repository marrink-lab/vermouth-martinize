...
def entry():
    ...
    # remove any secondary structure interactions that cross disordered/folded domains.
    vermouth.processors.IDRCrossDomainInteractionRemoval(go=args.go,
